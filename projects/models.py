...
class Project(models.Model):
    ...
    avg_truck_capacity = models.FloatField(
        blank=True,
        null=True,
    )
    infill_density = models.FloatField(
        blank=True,
        null=True,
    )
    infill_cost = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        blank=True,
        null=True,
    )
    avg_truck_cost = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        blank=True,
        null=True,
    )
    avg_production_time = models.FloatField(
        blank=True,
        null=True,
    )
    royalty = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        blank=True,
        null=True,
    )
    pur_per_year = models.FloatField(
        blank=True,
        null=True,
    )
    cem_content = models.FloatField(blank=True, null=True, default=0.16)
...
class Section(models.Model):
    ...
    concrete_volume = models.FloatField(null=True, blank=True)
    concrete_cost = models.DecimalField(
        max_digits=8, decimal_places=2, null=True, blank=True
    )
